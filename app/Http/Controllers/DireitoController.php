...
class DireitoController extends Controller
{
    /**
    ...
    public function destroy($id)
    {
     ...
     public function   eliminnoticiadir($id)
    {
    ...
    public function   eliminsugestaodir($id)
    {
...
// FUNÇÃO FAZENDO BUCAS & RETORNANDO NOTICIAS DA FAC. DIREITO 
